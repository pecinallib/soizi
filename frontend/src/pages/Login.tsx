          ...
          <div className="relative w-full">
            ...
            >
              ...
              <span className="text-xs text-text-muted mt-1.5 flex items-center gap-1.5">
                <span className="w-4 h-4 rounded-full bg-[#009C3B] flex items-center justify-center text-white text-[7px] font-bold shrink-0">
                  BR
                </span>
                BRL
              </span>
              ...
              {(['Entrar', 'Cadastrar'] as const).map((label) => {
                ...
                return (
                  <button
                    ...
                    className={`pb-3 text-lg font-heading font-bold transition-colors cursor-pointer ${
                      active
